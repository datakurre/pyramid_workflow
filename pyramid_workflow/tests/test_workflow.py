...
class WorkflowTests(unittest.TestCase):
    ...
    @mock.patch('pyramid_workflow.has_permission')
    ...
    def test_class_conforms_to_IWorkflow(self):
        ...
        from pyramid_workflow.interfaces import IWorkflow
...
class GetWorkflowTests(unittest.TestCase):
    ...
    def setUp(self):
        from pyramid_workflow import includeme
    ...
    def test_content_type_is_IDefaultWorkflow_no_registered_workflows(self):
        from pyramid_workflow.interfaces import IDefaultWorkflow
...
class add_workflowTests(unittest.TestCase):
    ...
    def _callFUT(self, workflow, config, content_types=(None,)):
        from pyramid_workflow import add_workflow
    ...
    def test_add_workflow_global(self):
        from pyramid_workflow.interfaces import IWorkflow
        from pyramid_workflow import register_workflow
