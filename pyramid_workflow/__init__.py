...
from pyramid_workflow.interfaces import (
    IWorkflow,
    IDefaultWorkflow,
    )

class WorkflowError(Exception):
    """Exception raised for anything related to :mod:`pyramid_workflow`.
    """
...
class Workflow(object):
    ...
    _state_attr_factory = dict  # overridable by instances / subclasses

    _state_attr = None

    def __init__(self, state_attr, initial_state, type, name='',
                 description=''):
        self._transitions = {}
        self._states = {}
    ...
    def _set_state(self, content, state, request, transition=None):
        ...
        setattr(content, self._state_attr, state)
        return state, msg
    ...
    def state_of(self, content):
        ...
        """
        return getattr(content, self._state_attr, None)
...
def get_workflow(request, type, content_type=None):
    ...
    :param content_type: content type or None for default workflow.
